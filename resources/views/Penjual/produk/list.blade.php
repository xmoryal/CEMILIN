...
@section('content')
  <main class="container py-4">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h3>List Produk</h3>
            <a href="{{ route('penjual.produk.add') }}" class="btn btn-outline-primary">+ Tambah Produk</a>
        </div>
                            ...
                            @foreach ($produk as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('penjual.produk.edit', $item->id) }}"
                                            class="btn btn-sm btn-primary">Edit</a>
                                        <form action="{{ route('penjual.produk.delete', $item->id) }}" method="POST"
                                            class="d-inline">
                                            @csrf
                                            @method('DELETE')
